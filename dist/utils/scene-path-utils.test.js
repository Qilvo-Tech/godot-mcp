...
import { assertSceneParentExists, buildSceneNodePath, getSceneNodePath, normalizeSceneNodePath, normalizeSceneParentPath, sceneHasNodePath, } from "./scene-path-utils.js";
const scene = {
...
describe("scene path utils", () => {
    ...
    it("validates parent paths after normalization", () => {
        ...
        expect(() => assertSceneParentExists(scene, "Main/Missing")).toThrow("Parent path not found in scene: Main/Missing");
    });
});
//# sourceMappingURL=scene-path-utils.test.js.map