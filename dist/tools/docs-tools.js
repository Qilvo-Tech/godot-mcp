...
const TOOL_GUIDE = {
    ...
    categories: {
        ...
        editor: {
            ...
            prerequisite: "Must install AI Bridge plugin; editor tools auto-connect on first use (godot_connect only for non-default host/port)",
        },
        shaders: {
...
function getToolPrerequisites(toolName) {
    ...
    if (toolName.startsWith("godot_editor_") || toolName.startsWith("godot_runtime_")) {
        requirements.push("An AI Bridge connection (established automatically on the first editor/runtime tool call).");
    }
    return requirements;
}
